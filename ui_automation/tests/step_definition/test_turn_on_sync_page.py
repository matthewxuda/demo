...
from ui_automation.page_objects.turn_on_sync_page.turn_on_sync_page_object import TurnOnSyncPageObject


@scenario("../features/snmp_discovery.feature", 'Sean can discovery snmp resources')
